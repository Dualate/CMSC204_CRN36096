...
public class MyStackTest {
	...
	public void testPopStudent() {
		assertEquals(doubleS.pop(), three);
		assertEquals(doubleS.pop(), two);
		assertEquals(doubleS.pop(), one);
	}
	...
	public void testPushStudent() {
		try {
			...
			assertTrue("This should have cause an StackOverflowException", true);
		}
	}
	...
	public void testToStringStudent() {
		assertEquals("10.0+20.0+30.0", doubleS.toString("+"));
		assertEquals("10.020.030.0", doubleS.toString());
	}
